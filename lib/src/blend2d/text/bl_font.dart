...
class BLFontFace {
  ...
  /// Construtor interno. Use [BLFontFace.parse] para criar uma face a partir
  /// dos bytes de um arquivo de fonte — este construtor recebe o estado já
  /// decodificado das tabelas OpenType e não é utilizável de fora.
  BLFontFace._({
